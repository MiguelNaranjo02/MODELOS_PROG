...
public class Enano extends Plantilla {
    ...
    //Constructor que inicializa y guarda la informacion especifica del Enano en los arreglos
    public Enano() {
        ...
        descripcion = "Son más bajos que cualquier otra raza, exceptuando a los hobbits"
                ...
                + "razas. Todos tienen barba, tanto hombres como mujeres, y el cortársela es la mayor "
