...
// Se crean los arraylist con los que se manejara mejor la informacion del personaje
    ...
    //Metodo Liskov que recibe un objeto plantilla, pero que en realidad recibira objetos
    //que heredan de plantilla
    //El metodo se encrga de obtener, randomizar y guardar la informacion que seria enviada al servlet
    public void Liskov(Plantilla plan) {
        ...
        this.AlturaFinal = Math.random() * ((double) plan.altura[0] - (double) plan.altura[1]) + (double) plan.altura[1];
