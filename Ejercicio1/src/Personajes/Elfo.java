...
public class Elfo extends Plantilla {
    ...
    //Constructor que inicializa y guarda la informacion especifica del Elfo en los arreglos
    public Elfo() {
        ...
        descripcion = "Los Elfos son seres inmortales que no envejecen como los mortales. "
